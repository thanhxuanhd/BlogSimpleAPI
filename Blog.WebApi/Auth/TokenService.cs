...
public class TokenService : ITokenService
{
    ...
    {
        var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_configuration["JwtIssuerOptions:SecretKey"]));
        ...
        var jwtToken = new JwtSecurityToken(
            ...
            expires: DateTime.UtcNow.AddMinutes(int.Parse(_configuration["JwtIssuerOptions:AccessTokenDurationInMinutes"])),
